...
namespace CHARACTER
{
<<<<<<< HEAD:Assets/visualnovel/scripts/Core/Characters/Character.cs
    public abstract class VisualNovelCharater
=======
    public abstract class VNCharacter
>>>>>>> mergeCombat:Assets/visualnovel/scripts/Core/Characters/VNCharacter.cs
    {
...
=======
        public VNCharacter(string name, CharacterConfigData config, GameObject prefab)
>>>>>>> mergeCombat:Assets/visualnovel/scripts/Core/Characters/VNCharacter.cs
        { 
            this.name = name;
            displayName = name;
