...
public class ChoicePanel : MonoBehaviour
{
    ...
    private const float BUTTON_MAX_SIZE = 2000;
    private const float BUTTON_WIDTH_PADDING = 100;
    private const float BUTTON_HEIGHT_PER_LINE = 200;
    ...
    public void Show(string question, string[] choices)
    {
        ...
        if (cgController == null) Debug.LogError("It all your fault 3");
        cgController.Show();
